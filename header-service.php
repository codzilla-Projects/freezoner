...
<body>
        ...
        <div class="header-top">
            <div class="auto-container clearfix">
                <div class="top-left clearfix">
                    <div class="text"><span class="icon flaticon-phone-call"></span> <a href="tel:<?=get_option('fz_phone'); ?>" class="number"><?=get_option('fz_phone'); ?></a></div>
                </div>
    ...
    <!-- End Main Header -->
    <!--Page Title-->
    <section id="page-title" class="page-title centered" style="background: fixed center center url('<?php $page_image = get_post_meta(get_the_ID(),'fz_services_image',true);; if(empty($page_image)){ echo fz_URL ."assets/images/background/5.jpg" ;} else{ echo $page_image;}?> ');background-size: cover;">
