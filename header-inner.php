...
<body>
    ...
    <!-- End Main Header -->
    <!--Page Title-->
    <section id="page-title" class="page-title centered" style="background: fixed center center url('<?php $page_image = get_the_post_thumbnail_url(); if(empty($page_image)){ echo fz_URL ."assets/images/background/5.jpg" ;} else{ echo $page_image;}?> ');background-size: cover;">
