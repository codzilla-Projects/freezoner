    ...
    <header class="main-header header-style-four">
        ...
        <div class="header-top">
            ...
            <div class="auto-container clearfix">
                ...
                <div class="top-left clearfix">
                    ...
                    <div class="text"><a href="tel:<?=get_option('fz_phone'); ?>" class="number"><span><strong style="color: transparent;">1</strong><?php _e(get_option('fz_email'),'freezoner'); ?></span></a></div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                ...
                <div class="nav-logo"><a href="<?php bloginfo('url'); ?>"><img src="<?= get_option('sh_logo_img'); ?>" alt="" title="<?php bloginfo('name'); ?>"></a></div>
